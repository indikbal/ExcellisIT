    ...
    return(
            <div>
                            ...
                            <div class="col-md-8">
                                <div class="left_foo_con_sec" data-aos="fade-up" data-aos-duration="1500">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="con_foo_input_wrapper">
                                                <label>What is your interest?<sup>*</sup></label>
                                                <select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="con_foo_input_wrapper">
                                                <label>Where did you here about us?<sup>*</sup> </label>
                                                <select>
                                                    <option value="Select Option">Select Option</option>
                ...
                <div class="right_persion_con_sec">
                    <div class="single_persion_con aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
                        <h4 class="theme_color">Speak to Sourav</h4>
                        <p>Manager Operations USA &amp; CAN</p>
                        <ul>
                            <li><a href="#"><i class="las la-phone-volume"></i> +1 602 671 4455</a></li>
                            <li><a href="#"><i class="las la-envelope"></i> sourav.dutta@excellisit.com</a></li>
                        </ul>
                    </div>
                    <div class="single_persion_con aos-init aos-animate" data-aos="fade-up" data-aos-duration="500">
                        <h4 class="theme_color">Speak to Harry</h4>
                        <p>Manager Operations India</p>
                        <ul>
                            <li><a href="#"><i class="las la-phone-volume"></i> (+91) 861 772 4646</a></li>
                            <li><a href="#"><i class="las la-envelope"></i> harry@excellisit.com</a></li>
                        </ul>
                    </div>
                    <div class="single_persion_con aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                        <h4 class="theme_color">Speak to Ali</h4>
                        <p>Director Global Operation</p>
                        <ul>
                            <li><a href="#"><i class="las la-phone-volume"></i>  033 4060 1168</a></li>
                            <li><a href="#"><i class="las la-envelope"></i> ali@excellisit.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row mt-100">
                            <div class="col-md-12">
                                <div class="colorLine"> <span></span><span></span><span></span><span></span> <span></span><span></span><span></span><span></span></div>
                            </div>
                        </div>
                            <CompanyAddress/>
                        </div>
